...
<div class="super_container">
        ...
        <div class="menu_container menu_mm">
            <div class="page_menu_content">
                ...
                <ul class="page_menu_nav menu_mm">
                    ...
                    <li class="page_menu_item has-children menu_mm">
                        <a href="{{ route('showCategory', $category->alias) }}">Categories<i class="fa fa-angle-down"></i></a>
                        <ul class="page_menu_selection menu_mm">
                            @foreach($categories as $category)
    ...
    <footer class="footer">
        <div class="footer_background" style="background-image:url(../../../../../../Development/Шаблоны/sublime1/sublime/images/footer.jpg)"></div>
        <div class="container">
            <div class="row">
                <div class="col">

            ...
            $('.product_sorting_btn').click(function () {
                ...
                $.ajax({
                    ...
                    success: (data) => {
                        ...
                        // параметры в строке запроса: http://eshopper/cameras?orderBy=default
                        let positionParameters = location.pathname.indexOf('?');
                        let url = location.pathname.substring(positionParameters, location.pathname.length);
                        let newURL = url + '?'; // http://eshopper/cameras?
                        newURL += 'orderBy=' + orderBy + "&page={{ isset($_GET['page']) ? $_GET['page']: 1 }}"; // http://eshopper/cameras?orderBy=price-high-low
                        ...
                        // статус наименовании сортировки
